...
conf = ionoscloud_container_registry.Configuration(
...
conf = ionoscloud_container_registry.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.ionos.com/containerregistries" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ionoscloud_container_registry")
        ...
        self.proxy: Optional[str] = os.environ.get('IONOS_HTTP_PROXY')
        """Proxy URL
        """
        self.proxy_headers = {}
