...
class PostRegistryOutput(BaseModel):
    """
    PostRegistryOutput
    """ # noqa: E501
    ...
    properties: Optional[RegistryProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": RegistryProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
