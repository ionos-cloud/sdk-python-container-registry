...
class TokensResponse(BaseModel):
    ...
    items: Optional[List[TokenResponse]] = None
    limit: Optional[StrictInt] = None
    offset: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_links", "count", "href", "id", "items", "limit", "offset", "total", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "href": obj.get("href"),
            "id": obj.get("id"),
            "items": [TokenResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "limit": obj.get("limit"),
