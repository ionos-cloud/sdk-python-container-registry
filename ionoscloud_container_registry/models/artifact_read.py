...
class ArtifactRead(BaseModel):
    ...
    ArtifactRead
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The digest of the artifact")
    type: Optional[StrictStr] = None
    href: Optional[StrictStr] = None
    metadata: Optional[ArtifactMetadata] = None
    properties: Optional[Artifact] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": Artifact.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
