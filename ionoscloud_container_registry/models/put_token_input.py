...
class PutTokenInput(BaseModel):
    """
    PutTokenInput
    """ # noqa: E501
    properties: Optional[PostTokenProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": PostTokenProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
