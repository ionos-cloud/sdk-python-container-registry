...
class PostRegistryInput(BaseModel):
    """
    PostRegistryInput
    """ # noqa: E501
    properties: Optional[PostRegistryProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": PostRegistryProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
